...
function copyCode() {
  ...
  scriptText += "drop database if exists "+databaseName+";"+"\n";
  scriptText += "create database "+databaseName+";\n";
  scriptText += "use "+databaseName+";\n\n";
  for (var t of Tables) {
     scriptText +="drop table if exists "+t.name+";\n";
  }
  for (var t of Tables) {
    scriptText += "\n";
...
function save()
{
   ...
   */
  let scriptText = "/* Generated By Scriptify Data Modeler Tool Version 1.0 */<br/><br/>";
  scriptText += "drop database if exists "+databaseName+";"+"<br/>";
  scriptText += "create database "+databaseName+";<br/>";
  scriptText += "use "+databaseName+";<br/><br/>";
  for (var t of Tables) {
    scriptText +="drop table if exists "+t.name+";<br/>";
   }
  for (var t of Tables) {
    scriptText += "\n";
